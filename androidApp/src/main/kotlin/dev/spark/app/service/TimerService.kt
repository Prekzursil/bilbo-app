...
class TimerService : Service() {
    ...
    companion object {
        // ── Actions ──────────────────────────────────────────────────────────
        const val ACTION_START_TIMER     = "dev.spark.app.action.START_TIMER"
        const val ACTION_STOP_TIMER      = "dev.spark.app.action.STOP_TIMER"
        const val ACTION_TIMER_TICK      = "dev.spark.app.action.TIMER_TICK"
        const val ACTION_TIMER_EXPIRED   = "dev.spark.app.action.TIMER_EXPIRED"
        const val ACTION_TIMER_WARNING   = "dev.spark.app.action.TIMER_WARNING"
        ...
        // ── Notification ──────────────────────────────────────────────────────
        const val CHANNEL_TIMER          = "spark_timer"
        const val CHANNEL_WARNING        = "spark_timer_warning"
        private const val NOTIF_FOREGROUND_ID = 1001

        // ── Prefs ─────────────────────────────────────────────────────────────
        private const val PREFS_NAME     = "spark_timer_state"
