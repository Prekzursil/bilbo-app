...
class UsageTrackingService : android.app.Service() {
    ...
    companion object {
        ...
        const val CHANNEL_ID = "spark_tracking_channel"
        const val ACTION_START = "dev.spark.app.action.START_TRACKING"
        const val ACTION_STOP = "dev.spark.app.action.STOP_TRACKING"
        const val ACTION_SCREEN_OFF = "dev.spark.app.action.SCREEN_OFF"
