...
import dev.bilbo.app.ui.overlay.EmotionalCheckInScreen
import dev.bilbo.app.ui.overlay.PostSessionMoodScreen
...
class EmotionalFlowController
    ...
    constructor(
        ...
        private suspend fun persistPostMood(
            checkInId: Long,
            emotion: Emotion,
        ) {
            try {
        ...
        private suspend fun getEmotionPattern(
            packageName: String,
            emotion: Emotion,
        ): EmotionPattern? {
            return try {
