 ...
 * by [dev.bilbo.app.BuildConfig.USE_ACCESSIBILITY_SERVICE]).
 *
...
class UsageMonitorService : Service() {
    ...
    companion object {
        ...
        const val ACTION_START = "dev.bilbo.app.action.START_MONITOR"
        const val ACTION_STOP = "dev.bilbo.app.action.STOP_MONITOR"
    }
