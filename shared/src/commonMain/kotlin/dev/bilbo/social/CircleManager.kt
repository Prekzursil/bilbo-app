...
class CircleManager {
    ...
    fun removeMember(
        ...
        val requester =
            getActiveMembership(circleId, requestingUserId)
                ?: return false
    ...
    fun promoteToAdmin(
        ...
        val target =
            getActiveMembership(circleId, targetUserId)
    ...
    private fun getActiveMembership(
        circleId: String,
        userId: String,
