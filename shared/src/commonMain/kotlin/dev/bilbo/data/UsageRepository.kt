...
/** Read-only queries over [UsageSession] records. */
...
/** Mutating operations over [UsageSession] records. */
interface UsageMutations {
    /**
...
/**
 * Repository for persisting and querying [UsageSession] records. Composed of
 * [UsageQueries] (reads) and [UsageMutations] (writes). All suspend functions
