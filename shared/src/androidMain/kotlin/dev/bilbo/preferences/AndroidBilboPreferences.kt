...
class AndroidBilboPreferences(
    ...
    override var bypassList: List<String>
        ...
        set(value) {
            prefs.edit().putString("bypass_list", json.encodeToString(value)).apply()
        }
    ...
    override var fpEnabled: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean("fp_enabled", value).apply()
        }
    ...
    override var antiGamingEnabled: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean("anti_gaming_enabled", value).apply()
        }
    ...
    override var checkInEnabled: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean("check_in_enabled", value).apply()
        }

    override var coolingOffEnabled: Boolean
        get() = prefs.getBoolean("cooling_off_enabled", true)
        set(value) {
            prefs.edit().putBoolean("cooling_off_enabled", value).apply()
        }
    ...
    override var cloudInsightsEnabled: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean("cloud_insights_enabled", value).apply()
        }

    override var viewAnonymization: Boolean
        get() = prefs.getBoolean("view_anonymization", true)
        set(value) {
            prefs.edit().putBoolean("view_anonymization", value).apply()
        }
    ...
    override var sharingLevel: SharingLevelPref
        ...
        set(value) {
            prefs.edit().putString("sharing_level", value.name).apply()
        }

    override var userInterests: List<String>
        get() = json.decodeFromString(prefs.getString("user_interests", "[]")!!)
        set(value) {
            prefs.edit().putString("user_interests", json.encodeToString(value)).apply()
        }
    ...
    override var notificationPreferences: NotificationPreferences
        ...
        set(value) {
            prefs.edit().putString("notification_prefs", json.encodeToString(value)).apply()
        }
    ...
    override var seedDataLoaded: Boolean
        ...
        set(value) {
            prefs.edit().putBoolean("seed_data_loaded", value).apply()
        }
...
actual fun bilboPreferences(): BilboPreferences =
    throw IllegalStateException(
        "On Android, inject AndroidBilboPreferences(context) via your DI framework. " +
