// IosSparkPreferences.kt
// Spark — iOS Preferences (NSUserDefaults implementation)
//
...
class IosSparkPreferences : SparkPreferences {
...
actual fun sparkPreferences(): SparkPreferences = IosSparkPreferences()
